# TuneCurses – Terminal Music Player
...
This will produce the `tunecurses` executable.
...
Settings and playback position are saved to `~/.tunecurses_state` and restored on next launch.
